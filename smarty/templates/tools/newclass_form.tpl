...
<form action="" method="post" name="create_class_form" id="create_class_form">
    ...
    <fieldset>
        ...
        <textarea name="newclass_description" id="newclass_description" cols="53" rows="1">{$class->get('description')}</textarea>
        </div>
